...
<div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    <li>  
                    <button type="button" class="btn btn-info btn-outline waves-effect waves-light" data-toggle="modal" data-target="#add-contact"><i class="fa fa-plus"></i> Add User</button>
                     <button type="button" class="btn btn-default btn-outline waves-effect waves-light"><i class="fa fa-file-excel-o"></i> Export</button>
<a href="javascript:void()" class="btn btn-primary btn-outline waves-effect waves-light filtertemplate"><i class="fa fa-filter"></i> Filter</a></li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
            </div>
