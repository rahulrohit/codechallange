...
<div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Add Files</h4> </div>
        ...
        <!-- /.col-lg-12 -->
            ...
            <div class="box-body">
                   <form action="{{ action('FilesController@store') }}" method="post" enctype="multipart/form-data" id="leadForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 m-b-20">
                                        <label>Files</label>
                                        <input type="text" class="form-control" name="files" placeholder="Files Name"> 
                                    </div>
                                    <div class="col-sm-12 m-b-20">
                                        <label>Folder</label>
										 <select class="form-control" name="folder_id" required>
										  <option value="">Select Folder </option>
                                           @foreach($data['dropdown'] as $key => $data)
